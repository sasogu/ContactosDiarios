(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();const F="0.0.69";(function(){try{const t=localStorage.getItem("app_version");if(t&&t!==F){const s=localStorage.getItem("contactos_diarios"),i=localStorage.getItem("contactos_diarios_backups"),a=localStorage.getItem("contactos_diarios_backup_fecha"),o=localStorage.getItem("contactos_diarios_webdav_config");["app_version","contactos_diarios","contactos_diarios_backups","contactos_diarios_backup_fecha","contactos_diarios_webdav_config"].forEach(p=>{p!=="contactos_diarios"&&localStorage.removeItem(p)}),"caches"in window&&caches.keys().then(p=>{p.forEach(b=>{(b.includes("contactosdiarios")||b.includes("contactos-diarios"))&&caches.delete(b)})}),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.getRegistrations().then(p=>{p.forEach(b=>{b.scope.includes(window.location.origin)&&b.unregister()})}),s&&localStorage.setItem("contactos_diarios",s),i&&localStorage.setItem("contactos_diarios_backups",i),a&&localStorage.setItem("contactos_diarios_backup_fecha",a),o&&localStorage.setItem("contactos_diarios_webdav_config",o),location.reload()}localStorage.setItem("app_version",F)}catch{}})();function H({contacts:n,filter:t,onSelect:s,onDelete:i}){let a=t?n.filter(o=>{const d=t.toLowerCase(),p=o.notes?Object.values(o.notes).join(" ").toLowerCase():"";return o.tags?.some(b=>b.toLowerCase().includes(d))||o.name?.toLowerCase().includes(d)||o.surname?.toLowerCase().includes(d)||p.includes(d)}):n;return a=a.slice().sort((o,d)=>d.pinned&&!o.pinned?1:o.pinned&&!d.pinned?-1:(o.surname||"").localeCompare(d.surname||"")),`
  ...
  `}function Q({contacts:n,visible:t,page:s=1}){let i=[];n.forEach((h,x)=>{h.notes&&Object.entries(h.notes).forEach(([y,w])=>{i.push({date:y,text:w,contact:h,contactIndex:x})})}),i.sort((h,x)=>x.date.localeCompare(h.date));const a=4,o=Math.max(1,Math.ceil(i.length/a)),d=Math.min(Math.max(s,1),o),p=(d-1)*a,b=i.slice(p,p+a);return`
  ...
  `;const a=t==="success"?"✅":t==="error"?"❌":t==="warning"?"⚠️":"ℹ️";i.innerHTML=`${a} ${n}`,s.appendChild(i),setTimeout(()=>{i.style.opacity="1",i.style.transform="translateX(0)"},10);const o=()=>{i.style.opacity="0",i.style.transform="translateX(100%)",setTimeout(()=>{i.parentNode&&i.parentNode.removeChild(i)},300)};i.onclick=o,setTimeout(o,4e3)}function L(n){const t=[];return!n.name||n.name.trim().length===0?t.push("El nombre es obligatorio"):n.name.trim().length<2?t.push("El nombre debe tener al menos 2 caracteres"):n.name.trim().length>50&&t.push("El nombre no puede tener más de 50 caracteres"),n.surname&&n.surname.trim().length>50&&t.push("Los apellidos no pueden tener más de 50 caracteres"),n.phone&&n.phone.trim().length>0&&(/^[\d\s\-\+\(\)\.]{6,20}$/.test(n.phone.trim())||t.push("El teléfono debe contener solo números, espacios y caracteres válidos (6-20 caracteres)")),n.email&&n.email.trim().length>0&&(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n.email.trim())?n.email.trim().length>100&&t.push("El email no puede tener más de 100 caracteres"):t.push("El email debe tener un formato válido")),t}function O(n){const t=[];return!n||n.trim().length===0?(t.push("La nota no puede estar vacía"),t):(n.trim().length>1e3&&t.push("La nota no puede tener más de 1000 caracteres"),n.trim().length<3&&t.push("La nota debe tener al menos 3 caracteres"),/^[\w\s\.\,\;\:\!\?\-\(\)\[\]\"\'\/\@\#\$\%\&\*\+\=\<\>\{\}\|\~\`\ñÑáéíóúÁÉÍÓÚüÜ]*$/.test(n)||t.push("La nota contiene caracteres no permitidos"),t)}const z="contactos_diarios";let e={contacts:ne(),selected:null,notes:"",editing:null,tagFilter:"",showAllNotes:!1,showBackupModal:!1,showAddNoteModal:!1,addNoteContactIndex:null,allNotesPage:1,duplicates:[],showDuplicateModal:!1,showAuthModal:!1,authMode:"login",pendingAction:null};function ne(){try{return JSON.parse(localStorage.getItem(z))||[]}catch{return[]}}function N(n){localStorage.setItem(z,JSON.stringify(n))}function m(){const n=document.querySelector("#app"),t=e.editing!==null?e.contacts[e.editing]:null,s=e.selected!==null?e.contacts[e.selected].notes||{}:{};n.innerHTML=`
    ...
    ${pe({duplicates:e.duplicates,visible:e.showDuplicateModal})} <!-- Modal de gestión de duplicados -->
    ${ve({visible:e.showAuthModal,mode:e.authMode})} <!-- Modal de autenticación -->
    ${Z({})}
  `,oe();const i=document.getElementById("show-backup-modal");i&&(i.onclick=()=>{e.showBackupModal=!0,m()});const a=document.getElementById("close-backup-modal");a&&(a.onclick=()=>{e.showBackupModal=!1,m()}),document.querySelectorAll(".add-note-contact").forEach(p=>{p.onclick=b=>{const h=Number(p.dataset.index);if(!D()){e.pendingAction={type:"addNote",contactIndex:h},_()?e.authMode="login":e.authMode="setup",e.showAuthModal=!0,m();return}e.addNoteContactIndex=h,e.showAddNoteModal=!0,m()}});const o=document.getElementById("cancel-add-note");o&&(o.onclick=()=>{e.showAddNoteModal=!1,e.addNoteContactIndex=null,m()}),document.querySelectorAll(".restore-backup-btn").forEach(p=>{p.onclick=()=>de(p.dataset.fecha)});const d=document.getElementById("restore-local-backup");d&&(d.onclick=restaurarBackupLocal)}let V=null;function oe(){const n=document.getElementById("tag-filter");n&&n.addEventListener("input",c=>{clearTimeout(V),V=setTimeout(()=>{e.tagFilter=n.value,m();const l=document.getElementById("tag-filter");l&&(l.value=e.tagFilter,l.focus(),l.setSelectionRange(e.tagFilter.length,e.tagFilter.length))},300)});const t=document.getElementById("add-contact");t&&(t.onclick=()=>{e.editing=null,e.selected=null,m(),e.editing=e.contacts.length,m()}),document.querySelectorAll(".select-contact").forEach(c=>{c.onclick=l=>{e.selected=Number(c.dataset.index),e.editing=null,m()}}),document.querySelectorAll(".edit-contact").forEach(c=>{c.onclick=l=>{e.editing=Number(c.dataset.index),e.selected=null,m()}}),document.querySelectorAll(".delete-contact").forEach(c=>{c.onclick=l=>{const r=Number(c.dataset.index),u=e.contacts[r],f=u.surname?`${u.surname}, ${u.name}`:u.name;confirm(`¿Estás seguro de eliminar el contacto "${f}"?

Esta acción no se puede deshacer.`)&&(e.contacts.splice(r,1),N(e.contacts),g("Contacto eliminado correctamente","success"),e.selected=null,m())}}),document.querySelectorAll(".pin-contact").forEach(c=>{c.onclick=l=>{const r=Number(c.dataset.index);e.contacts[r].pinned&&!confirm("¿Seguro que quieres desfijar este contacto?")||(e.contacts[r].pinned=!e.contacts[r].pinned,N(e.contacts),m())}});const s=document.getElementById("contact-form");s&&(s.onsubmit=c=>{c.preventDefault();const l=Object.fromEntries(new FormData(s)),r=L(l);if(r.length>0){g("Error de validación: "+r.join(", "),"error");return}let u=l.tags?l.tags.split(",").map(I=>I.trim()).filter(Boolean):[];delete l.tags;const f={...l};e.contacts.some((I,$)=>e.editing!==null&&$===e.editing?!1:U(I,f))&&!confirm("Ya existe un contacto similar. ¿Deseas guardarlo de todas formas?")||(e.editing!==null&&e.editing<e.contacts.length?(e.contacts[e.editing]={...e.contacts[e.editing],...l,tags:u},g("Contacto actualizado correctamente","success")):(e.contacts.push({...l,notes:{},tags:u}),g("Contacto añadido correctamente","success")),N(e.contacts),e.editing=null,m())},document.getElementById("cancel-edit").onclick=()=>{e.editing=null,m()});const i=document.getElementById("add-note-form");if(i&&e.addNoteContactIndex!==null){const c=l=>{l.preventDefault();const r=document.getElementById("add-note-date").value,u=document.getElementById("add-note-text").value.trim();if(!r||!u){g("Por favor, selecciona una fecha y escribe una nota","warning");return}const f=O(u);if(f.length>0){g("Error en la nota: "+f.join(", "),"error");return}const v=e.addNoteContactIndex;e.contacts[v].notes||(e.contacts[v].notes={}),e.contacts[v].notes[r]?e.contacts[v].notes[r]+=`
`+u:e.contacts[v].notes[r]=u,N(e.contacts),g("Nota añadida correctamente","success"),e.showAddNoteModal=!1,e.addNoteContactIndex=null,m()};i.onsubmit=c}const a=document.getElementById("note-form");if(a&&e.selected!==null){const c=l=>{l.preventDefault();const r=document.getElementById("note-date").value,u=document.getElementById("note-text").value.trim();if(!r||!u){g("Por favor, selecciona una fecha y escribe una nota","warning");return}const f=O(u);if(f.length>0){g("Error en la nota: "+f.join(", "),"error");return}e.contacts[e.selected].notes||(e.contacts[e.selected].notes={}),e.contacts[e.selected].notes[r]?e.contacts[e.selected].notes[r]+=`
`+u:e.contacts[e.selected].notes[r]=u,N(e.contacts),g("Nota guardada correctamente","success"),document.getElementById("note-text").value="",m()};a.onsubmit=c}document.querySelectorAll(".edit-note").forEach(c=>{c.onclick=l=>{const r=c.dataset.date,u=document.getElementById("edit-note-modal"),f=document.getElementById("edit-note-text");f.value=e.contacts[e.selected].notes[r],u.style.display="block",document.getElementById("save-edit-note").onclick=()=>{const v=f.value.trim(),I=O(v);if(I.length>0){g("Error en la nota: "+I.join(", "),"error");return}e.contacts[e.selected].notes[r]=v,N(e.contacts),g("Nota actualizada correctamente","success"),u.style.display="none",m()},document.getElementById("cancel-edit-note").onclick=()=>{u.style.display="none"}}}),document.querySelectorAll(".delete-note").forEach(c=>{c.onclick=l=>{const r=c.dataset.date;confirm(`¿Estás seguro de eliminar la nota del ${r}?
...
¿Deseas ver más detalles en la consola del navegador?`)&&console.table(c)}});const y=document.getElementById("cancel-duplicate-resolution");y&&(y.onclick=()=>{e.showDuplicateModal=!1,e.duplicates=[],m()});const w=document.getElementById("apply-resolution");w&&(w.onclick=fe),document.querySelectorAll('input[name^="resolution-"]').forEach(c=>{c.addEventListener("change",()=>{const l=c.name.split("-")[1],r=document.getElementById(`merge-section-${l}`),u=document.getElementById(`individual-section-${l}`);c.value==="merge"?(r.style.display="block",u.style.display="none"):c.value==="select"?(r.style.display="none",u.style.display="block"):(r.style.display="none",u.style.display="none")})}),document.querySelectorAll('.resolution-option input[type="radio"]').forEach(c=>{c.addEventListener("change",()=>{const l=c.name;document.querySelectorAll(`input[name="${l}"]`).forEach(r=>{r.closest(".resolution-option").classList.remove("selected")}),c.closest(".resolution-option").classList.add("selected")})});const M=document.getElementById("unlock-notes-btn");M&&(M.onclick=()=>{e.selected!==null&&(e.pendingAction={type:"showContactNotes",contactIndex:e.selected}),_()?e.authMode="login":e.authMode="setup",e.showAuthModal=!0,m()});const q=document.getElementById("logout-btn");q&&(q.onclick=()=>{ye(),m()});const C=document.getElementById("auth-form");C&&!C.hasAttribute("data-handler-added")&&(C.setAttribute("data-handler-added","true"),C.onsubmit=c=>{c.preventDefault();const l=document.getElementById("auth-password").value.trim();if(!l){g("Por favor, introduce una contraseña","warning");return}if(e.authMode==="setup"){const r=document.getElementById("auth-password-confirm").value.trim();if(l!==r){g("Las contraseñas no coinciden","error");return}if(l.length<4){g("La contraseña debe tener al menos 4 caracteres","warning");return}ge(l),S.isAuthenticated=!0,S.sessionExpiry=Date.now()+30*60*1e3,e.showAuthModal=!1,C.reset(),setTimeout(()=>{K()},100),m()}else be(l)?(e.showAuthModal=!1,C.reset(),m()):(document.getElementById("auth-password").value="",document.getElementById("auth-password").focus())});const R=document.getElementById("cancel-auth");R&&(R.onclick=()=>{e.showAuthModal=!1,e.pendingAction=null,m()});const j=document.getElementById("auth-modal");if(j){j.onclick=r=>{r.target===j&&(e.showAuthModal=!1,e.pendingAction=null,m())};const c=document.getElementById("auth-password");if(c){const r=window.innerWidth<=700?300:100;setTimeout(()=>{c.focus(),window.innerWidth<=700&&c.scrollIntoView({behavior:"smooth",block:"center"})},r)}const l=r=>{r.key==="Escape"&&e.showAuthModal&&(e.showAuthModal=!1,e.pendingAction=null,m())};document.addEventListener("keydown",l)}}function ae(n){const t=[],s=n.split("END:VCARD");for(const i of s){const a=/FN:([^\n]*)/.exec(i)?.[1]?.trim(),o=/N:.*;([^;\n]*)/.exec(i)?.[1]?.trim()||"",d=/TEL.*:(.+)/.exec(i)?.[1]?.trim(),p=/EMAIL.*:(.+)/.exec(i)?.[1]?.trim();a&&t.push({name:a,surname:o,phone:d||"",email:p||"",notes:{},tags:[]})}return t}function se(n){return n.map(t=>`BEGIN:VCARD
VERSION:3.0
FN:${t.name}
N:${t.surname||""};;;;
TEL:${t.phone||""}
...
${b}`:t.notes[p]=b})}),t.pinned=n.some(o=>o.pinned),t}function me(n){const t=G(n);return`
  ...
  `}function pe({duplicates:n,visible:t}){return!t||n.length===0?'<div id="duplicate-modal" class="modal" style="display:none"></div>':`
...
`),a+=`
Esta acción no se puede deshacer.`,!confirm(a)){g("Operación cancelada","info");return}try{let o=0,d=0;const p=[];n.forEach(y=>{if(y.type==="merge"){const w=G(y.contacts);e.contacts.push(w),y.contacts.forEach(M=>{p.push(M.originalIndex)}),o++}else y.type==="delete"&&(y.toDelete.forEach(w=>{p.push(w)}),d+=y.toDelete.length)}),[...new Set(p)].sort((y,w)=>w-y).forEach(y=>{y<e.contacts.length&&e.contacts.splice(y,1)}),N(e.contacts);let h="Resolución completada: ";const x=[];o>0&&x.push(`${o} contacto(s) fusionado(s)`),d>0&&x.push(`${d} duplicado(s) eliminado(s)`),h+=x.join(" y "),g(h,"success"),e.showDuplicateModal=!1,e.duplicates=[],m()}catch(o){g("Error al aplicar resolución: "+o.message,"error")}}const P="contactos_diarios_auth";let S={isAuthenticated:!1,sessionExpiry:null};function W(n){let t=0;for(let s=0;s<n.length;s++){const i=n.charCodeAt(s);t=(t<<5)-t+i,t=t&t}return t.toString()}function ge(n){const t=W(n);localStorage.setItem(P,t),g("Contraseña establecida correctamente","success")}function he(n){const t=localStorage.getItem(P);return t?W(n)===t:!1}function _(){return localStorage.getItem(P)!==null}function be(n){return he(n)?(S.isAuthenticated=!0,S.sessionExpiry=Date.now()+30*60*1e3,g("Autenticación exitosa","success"),setTimeout(()=>{K()},100),!0):(g("Contraseña incorrecta","error"),!1)}function D(){return S.isAuthenticated?Date.now()>S.sessionExpiry?(S.isAuthenticated=!1,S.sessionExpiry=null,!1):!0:!1}function ye(){S.isAuthenticated=!1,S.sessionExpiry=null,g("Sesión cerrada","info")}function K(){if(!e.pendingAction)return;const n=e.pendingAction;switch(e.pendingAction=null,n.type){case"showAllNotes":e.showAllNotes=!0,e.allNotesPage=1;break;case"addNote":e.addNoteContactIndex=n.contactIndex,e.showAddNoteModal=!0;break;case"showContactNotes":e.selected=n.contactIndex,e.editing=null;break}m()}function ve({visible:n,mode:t="login"}){return`
  ...
  `}function xe(){return window.innerWidth<=700||/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}function Ee(){if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&(document.body.style.webkitOverflowScrolling="touch"),window.matchMedia("(display-mode: standalone)").matches&&(document.body.classList.add("pwa-mode"),/iPhone/.test(navigator.userAgent)&&(document.body.style.paddingTop="env(safe-area-inset-top)")),xe()){const n=document.querySelector('meta[name="viewport"]');n&&n.setAttribute("content","width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover")}}document.addEventListener("DOMContentLoaded",()=>{m(),Ee()});let B=null;const k=document.createElement("button");k.textContent="📲 Instalar en tu dispositivo";k.className="add-btn";k.style.display="none";k.style.position="fixed";k.style.bottom="1.5rem";k.style.left="50%";k.style.transform="translateX(-50%)";k.style.zIndex="3000";document.body.appendChild(k);window.addEventListener("beforeinstallprompt",n=>{n.preventDefault(),B=n,k.style.display="block"});k.addEventListener("click",async()=>{if(B){B.prompt();const{outcome:n}=await B.userChoice;n==="accepted"&&(k.style.display="none"),B=null}});window.addEventListener("appinstalled",()=>{k.style.display="none"});
