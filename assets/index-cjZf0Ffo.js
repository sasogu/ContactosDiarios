(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))c(l);new MutationObserver(l=>{for(const n of l)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&c(o)}).observe(document,{childList:!0,subtree:!0});function i(l){const n={};return l.integrity&&(n.integrity=l.integrity),l.referrerPolicy&&(n.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?n.credentials="include":l.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function c(l){if(l.ep)return;l.ep=!0;const n=i(l);fetch(l.href,n)}})();const f="0.0.13";(function(){try{const e=localStorage.getItem("app_version");if(e&&e!==f){const i=localStorage.getItem("contactos_diarios");Object.keys(localStorage).forEach(c=>{c!=="contactos_diarios"&&localStorage.removeItem(c)}),"caches"in window&&caches.keys().then(c=>c.forEach(l=>caches.delete(l))),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.getRegistrations().then(c=>c.forEach(l=>l.unregister())),i&&localStorage.setItem("contactos_diarios",i),location.reload()}localStorage.setItem("app_version",f)}catch{}})();function b({contacts:a,filter:e,onSelect:i,onDelete:c}){let l=e?a.filter(n=>{const o=e.toLowerCase(),s=n.notes?Object.values(n.notes).join(" ").toLowerCase():"";return n.tags?.some(r=>r.toLowerCase().includes(o))||n.name?.toLowerCase().includes(o)||n.surname?.toLowerCase().includes(o)||s.includes(o)}):a;return l=l.slice().sort((n,o)=>o.pinned&&!n.pinned?1:n.pinned&&!o.pinned?-1:(n.surname||"").localeCompare(o.surname||"")),`
