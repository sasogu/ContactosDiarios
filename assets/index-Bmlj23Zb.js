(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))l(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function c(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function l(s){if(s.ep)return;s.ep=!0;const n=c(s);fetch(s.href,n)}})();const f="0.0.19";(function(){try{const e=localStorage.getItem("app_version");if(e&&e!==f){const c=localStorage.getItem("contactos_diarios");Object.keys(localStorage).forEach(l=>{l!=="contactos_diarios"&&localStorage.removeItem(l)}),"caches"in window&&caches.keys().then(l=>l.forEach(s=>caches.delete(s))),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.getRegistrations().then(l=>l.forEach(s=>s.unregister())),c&&localStorage.setItem("contactos_diarios",c),location.reload()}localStorage.setItem("app_version",f)}catch{}})();function h({contacts:o,filter:e,onSelect:c,onDelete:l}){let s=e?o.filter(n=>{const a=e.toLowerCase(),i=n.notes?Object.values(n.notes).join(" ").toLowerCase():"";return n.tags?.some(r=>r.toLowerCase().includes(a))||n.name?.toLowerCase().includes(a)||n.surname?.toLowerCase().includes(a)||i.includes(a)}):o;return s=s.slice().sort((n,a)=>a.pinned&&!n.pinned?1:n.pinned&&!a.pinned?-1:(n.surname||"").localeCompare(a.surname||"")),`
