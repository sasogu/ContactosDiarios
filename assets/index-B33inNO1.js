(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const m of i.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&o(m)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();const x="0.0.45";(function(){try{const e=localStorage.getItem("app_version");if(e&&e!==x){const s=localStorage.getItem("contactos_diarios");Object.keys(localStorage).forEach(o=>{o!=="contactos_diarios"&&localStorage.removeItem(o)}),"caches"in window&&caches.keys().then(o=>o.forEach(a=>caches.delete(a))),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.getRegistrations().then(o=>o.forEach(a=>a.unregister())),s&&localStorage.setItem("contactos_diarios",s),location.reload()}localStorage.setItem("app_version",x)}catch{}})();function N({contacts:n,filter:e}){let s=e?n.filter(o=>{const a=e.toLowerCase(),i=o.notes?Object.values(o.notes).join(" ").toLowerCase():"";return o.tags?.some(m=>m.toLowerCase().includes(a))||o.name?.toLowerCase().includes(a)||o.surname?.toLowerCase().includes(a)||i.includes(a)}):n;return s=s.slice().sort((o,a)=>a.pinned&&!o.pinned?1:o.pinned&&!a.pinned?-1:(o.surname||"").localeCompare(a.surname||"")),`
