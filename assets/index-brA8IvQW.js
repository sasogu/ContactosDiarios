(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))c(l);new MutationObserver(l=>{for(const n of l)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function i(l){const n={};return l.integrity&&(n.integrity=l.integrity),l.referrerPolicy&&(n.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?n.credentials="include":l.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function c(l){if(l.ep)return;l.ep=!0;const n=i(l);fetch(l.href,n)}})();const y="0.0.14";(function(){try{const e=localStorage.getItem("app_version");if(e&&e!==y){const i=localStorage.getItem("contactos_diarios");Object.keys(localStorage).forEach(c=>{c!=="contactos_diarios"&&localStorage.removeItem(c)}),"caches"in window&&caches.keys().then(c=>c.forEach(l=>caches.delete(l))),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.getRegistrations().then(c=>c.forEach(l=>l.unregister())),i&&localStorage.setItem("contactos_diarios",i),location.reload()}localStorage.setItem("app_version",y)}catch{}})();function x({contacts:o,filter:e,onSelect:i,onDelete:c}){let l=e?o.filter(n=>{const r=e.toLowerCase(),p=n.notes?Object.values(n.notes).join(" ").toLowerCase():"";return n.tags?.some(a=>a.toLowerCase().includes(r))||n.name?.toLowerCase().includes(r)||n.surname?.toLowerCase().includes(r)||p.includes(r)}):o;return l=l.slice().sort((n,r)=>r.pinned&&!n.pinned?1:n.pinned&&!r.pinned?-1:(n.surname||"").localeCompare(r.surname||"")),`
