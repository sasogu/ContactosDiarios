(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const d of n.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const z="0.1.01";(function(){try{const o=localStorage.getItem("app_version");if(o&&o!==z){const a=localStorage.getItem("contactos_diarios"),s=localStorage.getItem("contactos_diarios_backups"),i=localStorage.getItem("contactos_diarios_backup_fecha"),n=localStorage.getItem("contactos_diarios_webdav_config");["app_version","contactos_diarios","contactos_diarios_backups","contactos_diarios_backup_fecha","contactos_diarios_webdav_config"].forEach(u=>{u!=="contactos_diarios"&&localStorage.removeItem(u)}),"caches"in window&&caches.keys().then(u=>{u.forEach(h=>{(h.includes("contactosdiarios")||h.includes("contactos-diarios"))&&caches.delete(h)})}),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.getRegistrations().then(u=>{u.forEach(h=>{h.scope.includes(window.location.origin)&&h.unregister()})}),a&&localStorage.setItem("contactos_diarios",a),s&&localStorage.setItem("contactos_diarios_backups",s),i&&localStorage.setItem("contactos_diarios_backup_fecha",i),n&&localStorage.setItem("contactos_diarios_webdav_config",n),location.reload()}localStorage.setItem("app_version",z)}catch{}})();function te({contacts:t,filter:o,onSelect:a,onDelete:s}){let i=o?t.filter(n=>{const d=o.toLowerCase(),u=n.notes?Object.values(n.notes).join(" ").toLowerCase():"";return n.tags?.some(h=>h.toLowerCase().includes(d))||n.name?.toLowerCase().includes(d)||n.surname?.toLowerCase().includes(d)||u.includes(d)}):t;return i=i.slice().sort((n,d)=>{if(d.pinned&&!n.pinned)return 1;if(n.pinned&&!d.pinned)return-1;if(n.pinned===d.pinned){const u=n.lastEdited||0;return(d.lastEdited||0)-u}return 0}),`
    <div class="contact-list">
      <h2>Contactos</h2>
      <input id="tag-filter" class="tag-filter" placeholder="Buscar nombre, apellidos, etiqueta o nota..." value="${o||""}" />
      <ul>
        ${i.length===0?'<li class="empty">Sin contactos</li>':i.map((n,d)=>{const u=Date.now(),h=24*60*60*1e3,f=n.lastEdited&&u-n.lastEdited<h,x=f&&!n.pinned?" recently-edited":"";let b="";if(n.lastEdited){const y=u-n.lastEdited,N=Math.floor(y/(60*60*1e3)),B=Math.floor(y%(60*60*1e3)/(60*1e3));N<1?b=B<1?"Ahora":`${B}m`:N<24?b=`${N}h`:b=`${Math.floor(N/24)}d`}return`
  ...
  `}function ne({notes:t}){if(!j())return`
  ...
  `}function se({contacts:t,visible:o,page:a=1}){let s=[];t.forEach((f,x)=>{f.notes&&Object.entries(f.notes).forEach(([b,y])=>{s.push({date:b,text:y,contact:f,contactIndex:x})})}),s.sort((f,x)=>x.date.localeCompare(f.date));const i=4,n=Math.max(1,Math.ceil(s.length/i)),d=Math.min(Math.max(a,1),n),u=(d-1)*i,h=s.slice(u,u+i);return`
...
${h}`:o.notes[u]=h})}),o.pinned=t.some(n=>n.pinned),o}function Ee(t){const o=G(t);return`
  ...
  `}function xe({duplicates:t,visible:o}){return!o||t.length===0?'<div id="duplicate-modal" class="modal" style="display:none"></div>':`
...
Esta acción no se puede deshacer.`,!confirm(i)){v("Operación cancelada","info");return}try{let n=0,d=0;const u=[];t.forEach(b=>{if(b.type==="merge"){const y=G(b.contacts);e.contacts.push(y),b.contacts.forEach(N=>{u.push(N.originalIndex)}),n++}else b.type==="delete"&&(b.toDelete.forEach(y=>{u.push(y)}),d+=b.toDelete.length)}),[...new Set(u)].sort((b,y)=>y-b).forEach(b=>{b<e.contacts.length&&e.contacts.splice(b,1)}),S(e.contacts);let f="Resolución completada: ";const x=[];n>0&&x.push(`${n} contacto(s) fusionado(s)`),d>0&&x.push(`${d} duplicado(s) eliminado(s)`),f+=x.join(" y "),v(f,"success"),e.showDuplicateModal=!1,e.duplicates=[],m()}catch(n){v("Error al aplicar resolución: "+n.message,"error")}}const R="contactos_diarios_auth";let I={isAuthenticated:!1,sessionExpiry:null};function K(t){let o=0;for(let a=0;a<t.length;a++){const s=t.charCodeAt(a);o=(o<<5)-o+s,o=o&o}return o.toString()}function ke(t){const o=K(t);localStorage.setItem(R,o),v("Contraseña establecida correctamente","success")}function $e(t){const o=localStorage.getItem(R);return o?K(t)===o:!1}function P(){return localStorage.getItem(R)!==null}function Se(t){return $e(t)?(I.isAuthenticated=!0,I.sessionExpiry=Date.now()+30*60*1e3,v("Autenticación exitosa","success"),setTimeout(()=>{X()},100),!0):(v("Contraseña incorrecta","error"),!1)}function j(){return I.isAuthenticated?Date.now()>I.sessionExpiry?(I.isAuthenticated=!1,I.sessionExpiry=null,!1):!0:!1}function Ie(){I.isAuthenticated=!1,I.sessionExpiry=null,v("Sesión cerrada","info")}function X(){if(!e.pendingAction)return;const t=e.pendingAction;switch(e.pendingAction=null,t.type){case"showAllNotes":e.showAllNotes=!0,e.allNotesPage=1;break;case"addNote":e.addNoteContactIndex=t.contactIndex,e.showAddNoteModal=!0;break;case"showContactNotes":e.selected=t.contactIndex,e.editing=null;break}m()}function Ne({visible:t,mode:o="login"}){return`
  ...
  `;try{const o=await Ce();t.innerHTML=`
